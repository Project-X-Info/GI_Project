 ...
 * LinkedList f�r die komfortablere Navigation in der Liste der Knoten --> Adjazenzliste
 */
...
public class NodeList {
    ...
    public void add(Node k, double dist) {
        if (k == null) {
            return;
        }
        NodeElem newElem = new NodeElem(k,dist);
        if (tail != null) {
